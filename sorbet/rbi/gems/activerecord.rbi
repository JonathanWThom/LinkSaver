...
class ActiveRecord::ConnectionAdapters::PostgreSQLTypeMetadata < Anonymous_Delegator_17
  def ==(other); end
  def array; end
  def attributes_for_hash; end
  def eql?(other); end
...
class ActiveRecord::PredicateBuilder::RangeHandler::RangeWithBinds < Anonymous_Struct_18
  def exclude_end?; end
end
