...
class Net::HTTP < Net::Protocol
  def request_without_sk(req, body = nil, &block); end
end
...
class ActionDispatch::RequestId
  ...
  def internal_request_id_without_sk; end
end
...
class ActionView::TemplateRenderer < ActionView::AbstractRenderer
  def render_with_layout_without_sk(path, locals); end
end
module Skylight::Core::Probes::Middleware
end
class Skylight::Core::Probes::Middleware::Probe
  def install; end
  def self.add_instrumentation(middleware, default_name: nil, category: nil); end
  def self.disable!; end
  def self.disabled?; end
  def self.enable!; end
end
