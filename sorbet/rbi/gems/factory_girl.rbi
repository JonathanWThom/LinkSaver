...
#
#   https://github.com/sorbet/sorbet-typed/new/master?filename=lib/factory_girl/all/factory_girl.rbi
#
# factory_girl-4.9.0
module FactoryGirl
  ...
  extend FactoryGirl::Syntax::Default
end
...
class FactoryGirl::AssociationDefinitionError < RuntimeError
end
class FactoryGirl::InvalidCallbackNameError < RuntimeError
end
class FactoryGirl::DuplicateDefinitionError < RuntimeError
end
class FactoryGirl::SequenceAbuseError < RuntimeError
end
class FactoryGirl::AttributeDefinitionError < RuntimeError
end
class FactoryGirl::MethodDefinitionError < RuntimeError
end
class FactoryGirl::InvalidFactoryError < RuntimeError
end
...
module FactoryGirl::Strategy
end
class FactoryGirl::Strategy::Build
...
class FactoryGirl::NullObject < BasicObject
...
class FactoryGirl::EvaluatorClassDefiner
  def evaluator_class; end
...
class FactoryGirl::Attribute::Static < FactoryGirl::Attribute
  def initialize(name, value, ignored); end
  def to_proc; end
end
class FactoryGirl::Attribute::Dynamic < FactoryGirl::Attribute
  def initialize(name, ignored, block); end
  def to_proc; end
end
class FactoryGirl::Attribute::Association < FactoryGirl::Attribute
  def association?; end
  def factory; end
  def initialize(name, factory, overrides); end
  def to_proc; end
end
class FactoryGirl::Attribute::Sequence < FactoryGirl::Attribute
  def initialize(name, sequence, ignored); end
  def to_proc; end
end
class FactoryGirl::Attribute::NonAttributeWriterValidator
...
class FactoryGirl::CallbacksObserver
...
class FactoryGirl::Declaration
  def ignored; end
  def initialize(name, ignored = nil); end
  def name; end
  def to_attributes; end
end
class FactoryGirl::Declaration::Static < FactoryGirl::Declaration
  def ==(other); end
  def build; end
  def initialize(name, value, ignored = nil); end
  def value; end
end
class FactoryGirl::Declaration::Dynamic < FactoryGirl::Declaration
  def ==(other); end
  def block; end
  def build; end
  def initialize(name, ignored = nil, block = nil); end
end
class FactoryGirl::Declaration::Association < FactoryGirl::Declaration
  def ==(other); end
  def build; end
  def initialize(name, *options); end
  def options; end
end
class FactoryGirl::Declaration::Implicit < FactoryGirl::Declaration
  def ==(other); end
  def build; end
  def factory; end
...
class FactoryGirl::Sequence::EnumeratorAdapter
...
module FactoryGirl::Syntax::Default
...
class FactoryGirl::Syntax::Default::ModifyDSL
  def factory(name, options = nil, &block); end
  def self.run(block); end
end
...
class FactoryGirl::Decorator < BasicObject
  def initialize(component); end
  def method_missing(name, *args, &block); end
  def self.const_missing(name); end
  def send(symbol, *args, &block); end
end
class FactoryGirl::Decorator::AttributeHash < FactoryGirl::Decorator
  def attributes; end
  def initialize(component, attributes = nil); end
end
class FactoryGirl::Decorator::ClassKeyHash < FactoryGirl::Decorator
  def [](key); end
  def []=(key, value); end
  def key?(key); end
  def symbolized_key(key); end
end
class FactoryGirl::Decorator::DisallowsDuplicatesRegistry < FactoryGirl::Decorator
  def register(name, item); end
end
class FactoryGirl::Decorator::InvocationTracker < FactoryGirl::Decorator
  def __invoked_methods__; end
  def initialize(component); end
  def method_missing(name, *args, &block); end
end
class FactoryGirl::Decorator::NewConstructor < FactoryGirl::Decorator
...
class FactoryGirl::Linter::FactoryTraitError < FactoryGirl::Linter::FactoryError
